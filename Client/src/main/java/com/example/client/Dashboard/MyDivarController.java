...
public class MyDivarController {
    ...
    void SavedButton(ActionEvent event){
        try {
            Pane pane = FXMLLoader.load(Main.class.getResource("MyDivarPages/BookmarkedAds.fxml"));
            MyDivarPane.getChildren().clear();
            MyDivarPane.getChildren().add(pane);
        } catch (IOException ex){
            ex.printStackTrace();
    ...
    void RecentVisitsButton(ActionEvent event){
        try {
            Pane pane = FXMLLoader.load(Main.class.getResource("MyDivarPages/LastSeenAds.fxml"));
            MyDivarPane.getChildren().clear();
            MyDivarPane.getChildren().add(pane);
        } catch (IOException ex){
            ex.printStackTrace();
